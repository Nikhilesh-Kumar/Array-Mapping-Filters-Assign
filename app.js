...
// let moviez = movies.map(movie => 
//                 movie.title + ' ,' + " " + 'IMDb ratings' + " : " + movie.imdbRating);
// console.log(moviez);
...
// let moviez = movies.filter(movie => movie.genre=='Thriller').filter(movie => movie.year>2000)
// console.log(moviez);


// - Filter the movies to create an array of drama movies with IMDb ratings above 8.5.

// let moviez = movies.filter(movie => movie.genre=='Drama' && movie.imdbRating>8.5)
// console.log(moviez);


// - Filter the movies to create an array of action movies starring Leonardo DiCaprio.
// taken crime due to action movie of Leonardo DiCaprio

// let moviez = movies.filter(
//   movie => movie.genre === 'Crime' && movie.actors.includes('Leonardo DiCaprio')
// );
